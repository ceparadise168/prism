...
- `ask-eric` 是目前的 reference implementation，已有公開的驗證文件：[`docs/superpowers/specs/2026-04-05-ask-eric-test-analysis-report.md`](docs/superpowers/specs/2026-04-05-ask-eric-test-analysis-report.md)。
- `ask-founder` 已包含在 plugin 中，結構上是完整的，但目前公開的驗證證據較少。請參考 [`docs/superpowers/specs/2026-04-07-ask-founder-validation-status.md`](docs/superpowers/specs/2026-04-07-ask-founder-validation-status.md)。
