...
- `ask-eric/perspectives/*.md` — 19 perspective files, each with principles + anti-patterns
...
- **Perspective files follow a structure:** Core Principles → Judgment Criteria → Output Format, with Anti-Patterns included in perspectives where generic AI regression risk is highest (currently 6 of 19)
